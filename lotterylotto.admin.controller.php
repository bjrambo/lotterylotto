	...
	**************************************/
    ...
    class lotterylottoAdminController extends lotterylotto {
		...
		function procLotterylottoAdminConfig(){
			...
			$p_imgfile = 'point.gif'; $c_imgfile = 'cash.png';	//화폐이미지 설정
			...
			///////////////////////////////		당첨소감설정		//////////////////////////////////////////////
			$module_config->prize_msg_target = $args->prize_msg_target ? $args->prize_msg_target : array(1,2,3,4,5);		//당첨후기대상
        ...
        function procLotterylottoAdminLogDelete() {
            ...
            if(!$log_srls) $this->createObject(-1,'선택 대상이 없습니다');
